...
# below runs Remove-Item $WorkDir -Recurse -Force; a typo like
# -WorkDir C: combined with -Clean would attempt to wipe the entire
# drive. Caught before any work, matching the deploy script's
# $env:SystemDrive guard pattern on mountvol /d.
