...
| `-BitLockerPin` | String | Startup PIN for the TPM+PIN protector on `C:`. 6–20 characters. PIN content is the admin's call — no forbidden list is enforced (see [BitLocker guardrails](#bitlocker-guardrails) below). |
